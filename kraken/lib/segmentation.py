...
def _beveled_warping_envelope(baseline: np.ndarray, output_bl_start: Tuple[float, float], output_shape: Tuple[int, int]) -> Tuple[List[Tuple[int, int]], List[Tuple[int, int]]]:
    """
